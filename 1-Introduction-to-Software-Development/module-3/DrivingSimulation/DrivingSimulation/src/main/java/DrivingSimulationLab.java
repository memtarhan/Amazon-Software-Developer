...
public class DrivingSimulationLab {
    ...
    public static void changeGear() {
        ...
        String enteredGear = keyBoard.next();
        if (enteredGear.equals("P") || enteredGear.equals("D") || enteredGear.equals("R")) {
            gear = enteredGear;
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed > 5) {
            ...
            System.out.println("You are already slow, no need to break");
        }
    }
